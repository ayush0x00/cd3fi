    ...
    <div className="flex justify-center items-center flex-wrap">
      <div className="flex flex-col items-start flex-wrap ml-10 mt-10">
        <p className="text-white text-5xl font-semibold">
          The <span className="italic text-teal-400">Future</span> of finance
        </p>
        ...
        <Link to="/buy">
          <button className="px-10 py-2 rounded-lg hover:bg-teal-500 bg-teal-200 text-black font-semibold">
            GET YOUR NFB
          </button>
        </Link>
      </div>
